var map2 = L.map('map2').setView([43.8, -120.55], 7);

var MB_satelliteContours2 = L.tileLayer('https://api.mapbox.com/styles/v1/everythingismossome/cltq77934013u01r5bg5b9lf1/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoiZXZlcnl0aGluZ2lzbW9zc29tZSIsImEiOiJjbHNqOXZjd3oycHRrMmt0MHE1MWFjc3d2In0.BFb9k5gMVQGbDhX-3aEXzA',
 {}).addTo(map2);
...
var drawPluginOptions2 = {
    ...
    edit: {
        featureGroup: editableLayers2,
        remove: false
    }
};

// Initialise the draw control and pass it the FeatureGroup of editable layers
var drawControl2 = new L.Control.Draw(drawPluginOptions2);
